...
**Student Name:<insert your name here>**Hajar Awad AL-Dhafiri

**Student ID:<insert ID here>**2211007397
...
Brief Summary: This code calculates the frequency of each pet name
...
Loading the Required Library: library(ggplot2): Loads the ggplot2
library, which provides functions for creating data visualizations.
Creating a Bar Plot of Species Counts: species_plot \<-
